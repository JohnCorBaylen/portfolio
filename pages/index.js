        ...
        <section className="min-h-screen">
            ...
            <ul className="flex items-center">
              ...
              <li>
                <a
                  ...
                  href="resume.docx"
                  download="John Cor Baylen resume"
                  >
                  Resume
                </a>
              </li>
          ...
          <div className="text-center p-10 py-10">
            ...
            <p className="text-md py-5 leading-8 text-gray-800 dark:text-gray-200 max-w-xl mx-auto md:text-xl">
              ...
              knowledge and skills in terms of developing and designing.
            </p>
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              Seeking a reputable organization/company where
               I can showcase my technical skills and knowledge in application
            </p>
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              I offer from a range of services, including designing and 
              programming.
            </p>
          </div>
